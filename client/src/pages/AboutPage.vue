...
<template>
  <div class="about container mt-3">
    ...
    <p>I started meditating using apps such as Medito. The guided sessions really grew on me, but as time went on, I
      ...
      highly beneficial, but I also now wanted the option to meditate differently - whether using a different tool or
      just not relying on my phone.

      Most habit trackers I found online are great, but meditation was really the only habit I actually wanted to track
      daily.
    ...
    <p>Follow me on <a href="https://x.com/RomanOlsenHQ" target="_blank" rel="noopener noreferrer">X</a> or <a
      ...
      have any questions or suggestions! (My DMs on X are
      open)</p>
